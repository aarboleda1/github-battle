...
UserDetails.propTypes = {
  ...
  //shape allows you to have propTypes on certain key values 
  //so you don't have to require everything i.e blogs- not required to be filled out so not written
